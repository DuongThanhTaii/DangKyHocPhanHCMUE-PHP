...
/**
 * UseCase: Lấy thống kê đăng ký theo ngành
 * 
 * Business logic cho API GET /bao-cao/dk-theo-nganh
 */
class GetDangKyTheoNganhUseCase
{
    ...
    public function execute(BaoCaoFilterDTO $dto): array
    {
        ...
        $stats = $this->baoCaoRepository->getDangKyTheoNganh($dto->hocKyId, $dto->khoaId);
